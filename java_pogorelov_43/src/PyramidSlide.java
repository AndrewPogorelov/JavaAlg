// Напишите программу которая принимает на вход массивы чисел представляющие собой ряды пирамиды.
// Реализуйте функцию которая посчитает максимальную сумму скольжения.
// Спускаться на ряд вниз можно только на два соседних числа.
// На одном уровне может быть взято лишь одно число.
//        /3/
//        \7\ 4
//        2 \4\ 6
//        8 5 \9\ 3
...
public class PyramidSlide {
    public static void main(String[] args) {
        ...
        System.out.println("Maximum amount: " + maxSlide);
    }
